# Contributing to test-linkml-cookiecutter

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
test-linkml-cookiecutter. These guidelines are not strict rules.
...
The test-linkml-cookiecutter team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the test-linkml-cookiecutter technical leads
...
[issues]: https://github.com/yibeichan/test-linkml-cookiecutter/issues/
[pulls]: https://github.com/yibeichan/test-linkml-cookiecutter/pulls/
